...
{
  "dependencies": {
    "com.actionfit.ai-pr": "https://github.com/ActionFit-Editor/AI_PullRequest.git#1.0.10"
  }
}
```
...
write-capable `pull-request-run`도 Codex 기본 컨텍스트에 포함됩니다. 컨텍스트 노출은 commit, push 또는 PR 생성 승인이 아니며 사용자가 명시적으로 요청한 PR 범위에서만 실행합니다. Merge, branch/worktree 삭제, publish, deploy는 계속 수행하지 않으며 Refresh는 사용자 수정 및 unmanaged installed skill을 보존합니다.
